...
(function (root) {
  ...
  var MOCK_COMPARISONS = [
    ...
    { name: "V2", chart: "Applicants by Programme (MOCK)", comparison_date: "2026-07-25",
      ...
      accepted_reason: "", reviewed_by: "",
      comparison_rows: [
        { group_label: "Business (MOCK)", original_value: "30", new_value: "30",
          difference: "0", difference_pct: "0", status: "Match", reason: "" },
        { group_label: "Computing (MOCK)", original_value: "20", new_value: "17",
          difference: "-3", difference_pct: "-15", status: "Discrepancy", reason: "" },
        { group_label: "Design (MOCK)", original_value: "10", new_value: "10",
          difference: "0", difference_pct: "0", status: "Match", reason: "" },
      ] },
    { name: "V3", chart: "Admission Funnel (MOCK)", comparison_date: "2026-07-25",
      ...
      accepted_reason: "", reviewed_by: "",
      comparison_rows: [
        { group_label: "Applied (MOCK)", original_value: "12", new_value: "12",
          difference: "0", difference_pct: "0", status: "Match", reason: "" },
        // Blank difference, not 0 — this group could not be compared at all.
        { group_label: "Offered (MOCK)", original_value: "9", new_value: "",
          difference: "", difference_pct: "", status: "Flagged", reason: "missing" },
      ] },
